...
function App() {
  ...
  function connect() {
    ...
    signer.getAddress().then((address) => {
      batch(() => { //batch, birden fazla dispatch işlemi yapabilmemizi sağlar, batch sayesinde her değişken değeri değiştiğinde component render olmasın, hepsini bir kerede render etsin diye kullanılır
        dispatch(setSigner(signer)); //redux'ın güncelemesi için dispatch içinde kullanılır
